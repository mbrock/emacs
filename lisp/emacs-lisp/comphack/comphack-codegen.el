...
;    (c-mode)
    ...
    (compc-with-block
     (compc-insert-line "Lisp_Object (*wrong_type_argument) (Lisp_Object, Lisp_Object);")
     (compc-insert-line "Lisp_Object (*helper_PSEUDOVECTOR_TYPEP_XUNTAG) (Lisp_Object, Lisp_Object);")
     (compc-insert-line "Lisp_Object (*pure_write_error) (Lisp_Object);")
     (compc-insert-line "Lisp_Object (*push_handler) (Lisp_Object, Lisp_Object);")
     (compc-insert-line "Lisp_Object (*record_unwind_protect_excursion) (void);")
     (compc-insert-line "Lisp_Object (*helper_unbind_n) (Lisp_Object);")
     (compc-insert-line "Lisp_Object (*helper_save_restriction) (void);")
     (compc-insert-line "Lisp_Object (*helper_GET_SYMBOL_WITH_POSITION) (Lisp_Object);")
     (compc-insert-line "Lisp_Object (*helper_sanitizer_assert) (Lisp_Object, Lisp_Object);")
     (compc-insert-line "Lisp_Object (*record_unwind_current_buffer) (void);")
     (compc-insert-line "Lisp_Object (*set_internal) (Lisp_Object, Lisp_Object, Lisp_Object, Lisp_Object);")
     (compc-insert-line "Lisp_Object (*helper_unwind_protect) (Lisp_Object);")
     (compc-insert-line "Lisp_Object (*specbind) (Lisp_Object, Lisp_Object);")
     (compc-insert-line "Lisp_Object (*maybe_gc) (void);")
     (compc-insert-line "Lisp_Object (*maybe_quit) (void);")
